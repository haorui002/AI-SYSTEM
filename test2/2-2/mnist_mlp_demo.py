...
class MNIST_MLP(object):
    ...
    def load_data(self, data_path, label_path):
        ...
        test_images = self.load_mnist('/opt/code_chap_2_3/code_chap_2_3_student/mnist_data/t10k-images-idx3-ubyte', True)
        test_labels = self.load_mnist('/opt/code_chap_2_3/code_chap_2_3_student/mnist_data/t10k-labels-idx1-ubyte', False)
