...
class VGG19(object):
    ...
    def build_model(self, param_path='../../imagenet-vgg-verydeep-19.mat'):
        ...
        input_shape1p=pycnnl.IntVector(4)
        input_shape1p[0]=1
        input_shape1p[1]=64
        input_shape1p[2]=224
        input_shape1p[3]=224
        
        self.net.createPoolingLayer('pool1',input_shape1p,2,2)
        ...
        input_shape2p=pycnnl.IntVector(4)
        input_shape2p[0]=1
        input_shape2p[1]=128
        input_shape2p[2]=112
        input_shape2p[3]=112
        
        self.net.createPoolingLayer('pool2',input_shape2p,2,2)
        ...
        input_shape3p=pycnnl.IntVector(4)
        input_shape3p[0]=1
        input_shape3p[1]=256
        input_shape3p[2]=56
        input_shape3p[3]=56
        
        self.net.createPoolingLayer('pool3',input_shape3p,2,2)
        ...
        self.net.createReLuLayer('relum_6')
        ...
        self.net.createReLuLayer('relum_7')
